...
public class ListMembers extends Container implements ActionListener {
	JLabel errorMsg;
	String err;
	MemberController controller;
	
	public ListMembers(String err) {
		this.err = err;
	...
	private void initScreen() {
		...
		Vector<Vector<String>> mems = controller.getMultiple(null);
