...
public class UpdateOrder extends Container implements ActionListener {
	JLabel id;
	JTextField name;
	JTextField dob;
	JTextField author;
	...
	public void actionPerformed(ActionEvent e) {
		if(!Validator.isSet(id.getText())) {
        	...
        	else if(rs == -1) msg = "Book" + mem.getId() + " does not exist.";
        	else if(rs == 0) msg = "There is no data provided.";
        	else if(rs == 1) msg = "Book " + mem.getId() + " has been updated.";
