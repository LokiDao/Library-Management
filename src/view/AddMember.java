...
public class AddMember extends Container implements ActionListener {
	JTextField id;
	JTextField name;
	JTextField dob;
	JTextField gender;
	...
	public void actionPerformed(ActionEvent e) {
		if(!Validator.isSet(id.getText())) {
			...
			Member mem = new Member(id.getText(), name.getText(), dob.getText(), gender.getText());
			int rs = controller.add(mem);
			String msg = null;
        	if(rs == -3) msg = "An error occured.";
        	else if(rs == -2) msg = "Data source is still not opened yet.";
        	else if(rs == -1) msg = "Member " + mem.getId() + " is already existed.";
        	else if(rs == 0) msg = "There is no data provided.";
        	else if(rs == 1) msg = "Member " + mem.getId() + " has been added.";
